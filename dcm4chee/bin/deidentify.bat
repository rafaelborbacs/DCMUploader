...
set MAIN_JAR=dcm4che-tool-deidentify-5.29.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-dcmr-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-deident-5.29.2.jar
