...
set MAIN_JAR=dcm4che-tool-dcm2json-5.29.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-dict-priv-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-json-5.29.2.jar
