...
set MAIN_JAR=dcm4che-tool-probetc-5.29.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-api-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-ldap-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-prefs-5.29.2.jar
