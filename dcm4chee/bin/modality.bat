...
set MAIN_JAR=dcm4che-tool-ihe-modality-5.29.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mppsscu-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-storescu-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-stgcmtscu-5.29.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-mkkos-5.29.2.jar
